...
try {
  ...
  // Get Study ID and Condition from backend
          ...
          <div className="card research-card p-4 p-md-5">
            ...
            {loading && (
              <p
                ...
                aria-live="polite"
              >
                Saving consent, generating
                your Study ID, assigning the
                AI condition and preparing the
                next page. Please do not close
                this window.
              </p>
            )}
          </div>
